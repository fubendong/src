<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-23 11:01:14
         compiled from "/Users/fubendong/Sites/bzfshop/src/protected/Theme/Shop/manage/Tpl/theme_shop_headnav.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2393500853f803fa712a60-22003989%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '42a1f03e10776eb65021a28f12132d9523b0ee3a' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/protected/Theme/Shop/manage/Tpl/theme_shop_headnav.tpl',
      1 => 1408717014,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2393500853f803fa712a60-22003989',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f803fa7ab017_59227985',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f803fa7ab017_59227985')) {function content_53f803fa7ab017_59227985($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
">底部导航</a>
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#theme_shop_tabbar li:has(a[href='<?php echo smarty_helper_function_make_url(array('controller'=>'/Theme/Shop/HeadNav'),$_smarty_tpl);?>
'])").addClass("active");
        });
                ...
                <tr>
                    <td>
                        <input name="headNav[0][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[0]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[0][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[0]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <input name="headNav[1][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[1]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[1][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[1]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <input name="headNav[2][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[2]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[2][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[2]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <input name="headNav[3][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[3]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[3][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[3]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <input name="headNav[4][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[4]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[4][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[4]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <input name="headNav[5][title]" class="span2" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[5]['title'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                    <td>
                        <input name="headNav[5][url]" class="span6" type="text" data-no-validation="true"
                               value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['headNav']->value[5]['url'])===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
                    </td>
                </tr>
