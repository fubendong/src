<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-24 13:27:06
         compiled from "/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Manage/Tpl/plugin_theme_listtheme.tpl" */ ?>
<?php /*%%SmartyHeaderCode:189500554153f9778ea94a99-71738691%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d5460909bf5874973facecd0503d3f0f294b919' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Manage/Tpl/plugin_theme_listtheme.tpl',
      1 => 1408786193,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '189500554153f9778ea94a99-71738691',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1-DEV',
  'unifunc' => 'content_53f9778ebe2a43_62008873',
  'variables' => 
  array (
    'DEBUG' => 0,
    'authAdminUser' => 0,
...
<?php if ($_valid && !is_callable('content_53f9778ebe2a43_62008873')) {function content_53f9778ebe2a43_62008873($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
">主题管理</a></li>
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#plugin_tabbar li:has(a[href='<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/ListTheme'),$_smarty_tpl);?>
'])").addClass("active");
        });
    ...
    <div class="row">
        ...
        <?php if (isset($_smarty_tpl->tpl_vars['themeArray']->value)) {?>
            <?php  $_smarty_tpl->tpl_vars['themeItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['themeItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['themeArray']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['themeItem']->key => $_smarty_tpl->tpl_vars['themeItem']->value) {
$_smarty_tpl->tpl_vars['themeItem']->_loop = true;
?>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td>[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName'], ENT_QUOTES, 'UTF-8');?>
]&nbsp;&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['themeItem']->value['pluginDisplayName'], ENT_QUOTES, 'UTF-8');?>
</td>
                        <td rowspan="3" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['themeItem']->value['pluginDescText'];?>
</td>
                    </tr>
                    <tr>
                        <td>
                            已安装版本：<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['themeItem']->value['installVersion'], ENT_QUOTES, 'UTF-8');?>
&lt;----代码版本：<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['themeItem']->value['pluginVersion'], ENT_QUOTES, 'UTF-8');?>

                        </td>
                    </tr>
                    <tr>
                        <td>
                            <?php if ($_smarty_tpl->tpl_vars['themeItem']->value['pluginIsInstall']) {?>
                                <?php if ($_smarty_tpl->tpl_vars['themeItem']->value['pluginIsActive']) {?>
                                    <button class="btn btn-info">使用中</button>
                                    <a class="btn btn-danger" onclick="return confirm('你确定要停用这个主题吗？');"
                                       href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/DeactivateTheme','themeDirName'=>$_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName']),$_smarty_tpl);?>
">停用</a>
                                <?php } else { ?>
                                    <a class="btn" onclick="return confirm('你确定要启用这个主题吗？');"
                                       href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/ActivateTheme','themeDirName'=>$_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName']),$_smarty_tpl);?>
">启用</a>
                                    <a class="btn btn-danger" onclick="return confirm('你确定要卸载这个主题吗？');"
                                       href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/UninstallTheme','themeDirName'=>$_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName']),$_smarty_tpl);?>
">卸载</a>
                                <?php }?>

                                <?php if ($_smarty_tpl->tpl_vars['themeItem']->value['pluginIsNeedUpdate']) {?>
                                    <a class="btn btn-warning" onclick="return confirm('你确定要升级这个主题吗？');"
                                       href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/UpdateTheme','themeDirName'=>$_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName']),$_smarty_tpl);?>
">升级</a>
                                <?php }?>

                                <?php if ($_smarty_tpl->tpl_vars['themeItem']->value['pluginIsActive']&&$_smarty_tpl->tpl_vars['themeItem']->value['pluginConfigureUrl']) {?>
                                    <a class="btn btn-success"
                                       href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['themeItem']->value['pluginConfigureUrl'], ENT_QUOTES, 'UTF-8');?>
">设置</a>
                                <?php }?>
                            <?php } else { ?>
                                <a class="btn" onclick="return confirm('你确定要安装这个主题吗？');"
                                   href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Plugin/Theme/InstallTheme','themeDirName'=>$_smarty_tpl->tpl_vars['themeItem']->value['pluginDirName']),$_smarty_tpl);?>
">安装</a>
                            <?php }?>
