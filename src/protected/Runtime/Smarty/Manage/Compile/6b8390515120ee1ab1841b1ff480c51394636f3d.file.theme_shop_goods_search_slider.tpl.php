<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-23 11:01:07
         compiled from "/Users/fubendong/Sites/bzfshop/src/protected/Theme/Shop/manage/Tpl/theme_shop_goods_search_slider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76526864853f803f36ba191-34053303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b8390515120ee1ab1841b1ff480c51394636f3d' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/protected/Theme/Shop/manage/Tpl/theme_shop_goods_search_slider.tpl',
      1 => 1408717014,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '76526864853f803f36ba191-34053303',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f803f373b272_18845311',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f803f373b272_18845311')) {function content_53f803f373b272_18845311($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
">底部导航</a>
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#theme_shop_tabbar li:has(a[href='<?php echo smarty_helper_function_make_url(array('controller'=>'/Theme/Shop/GoodsSearchSlider'),$_smarty_tpl);?>
'])").addClass("active");
        });

        window.bz_set_breadcrumb_status.push({index: 1, text: '搜索页广告', link: window.location.href});
    </script>
    <div class="row">
...
?>
                            <div class="row theme_shop_slider_image_container">
                                <div class="span10 theme_shop_goods_search_slider_image_wrapper">
        ...
        <div id="theme_shop_slider_image_container_clone" class="row theme_shop_slider_image_container">
            <div class="span10 theme_shop_goods_search_slider_image_wrapper">
                <a target="_blank" href="#">
                    <img src="<?php echo theme_shop_smarty_helper_function_get_asset_url(array('asset'=>'img/placeholder_1000x250.gif'),$_smarty_tpl);?>
"/>
                </a>
                <input type="hidden" name="image[]"
                       value="<?php echo theme_shop_smarty_helper_function_get_asset_url(array('asset'=>'img/placeholder_1000x250.gif'),$_smarty_tpl);?>
"/>
