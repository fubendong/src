<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-23 11:03:18
         compiled from "/Users/fubendong/Sites/bzfshop/src/protected/Theme/Manage/Tpl/stat_order_index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127140805453f8047648c993-53720725%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'def7cb0113e3a54f9f5750b66641da957786e8ff' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/protected/Theme/Manage/Tpl/stat_order_index.tpl',
      1 => 1408717013,
      2 => 'file',
    ),
    '3b95b0d17c80ec63673916bc9f5c6578cfac2b95' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/protected/Theme/Manage/Tpl/stat_order_layout.tpl',
      1 => 1408717013,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '127140805453f8047648c993-53720725',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f8047653bcc3_72614988',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f8047653bcc3_72614988')) {function content_53f8047653bcc3_72614988($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
">业绩考核</a></li>
    ...
    <script type="text/javascript">
        window.bz_set_nav_status.push(function ($) {
            $("#stat_tabbar li:has(a[href='<?php echo smarty_helper_function_make_url(array('controller'=>'/Stat/Order/Index'),$_smarty_tpl);?>
'])").addClass("active");
        });
    </script>
    <!-- 订单统计主体内容 -->
    <div class="tabbable tabs-left">
        ...
        <ul id="stat_order_tab_left" class="nav nav-tabs">
            <li class=""><a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Stat/Order/Refer'),$_smarty_tpl);?>
">来源渠道</a></li>
        </ul>
        <!-- /订单统计左侧标签导航 -->
    ...
    <script type="text/javascript">
        window.bz_set_breadcrumb_status.push({index: 1, text: '订单统计', link: window.location.href});
    </script>
    <!-- 左侧每个标签的具体内容 -->
