<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-24 13:27:19
         compiled from "/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/shop_index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175056204753f88717c96f43-68380040%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a775f323ca49d5be10d732d6eed29493c41580c' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/shop_index.tpl',
      1 => 1408809993,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '175056204753f88717c96f43-68380040',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1-DEV',
  'unifunc' => 'content_53f88717e2a015_47121758',
  'variables' => 
  array (
    'seo_title' => 0,
    'seo_description' => 0,
...
<?php if ($_valid && !is_callable('content_53f88717e2a015_47121758')) {function content_53f88717e2a015_47121758($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<!-- /网站公告、店长商品推荐 -->
	...
	<div class="recom_box">
		...
		<div class="show_box">
			<ul>
			<?php  $_smarty_tpl->tpl_vars['goodItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['goodItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['newGoodsArray']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['goodItem']->key => $_smarty_tpl->tpl_vars['goodItem']->value) {
$_smarty_tpl->tpl_vars['goodItem']->_loop = true;
?>
				<li>
					<div class="block">
						<div class="clear"></div>
						<div class="thumb"><a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Goods/View','goods_id'=>$_smarty_tpl->tpl_vars['goodItem']->value['goods_id']),$_smarty_tpl);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['goodItem']->value['goods_name'], ENT_QUOTES, 'UTF-8');?>
" target="_blank">
							
                                          <img class="lazyload" src="<?php echo smarty_helper_function_get_asset_url(array('asset'=>'img/blank.gif'),$_smarty_tpl);?>
"
                                         data-original="<?php echo smarty_helper_function_goods_thumb_image(array('goods_id'=>$_smarty_tpl->tpl_vars['goodItem']->value['goods_id']),$_smarty_tpl);?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['goodItem']->value['goods_name'], ENT_QUOTES, 'UTF-8');?>
" width="230" height="230"/>
                                          
						</a><cite></cite></div>
						<div class="title"><a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Goods/View','goods_id'=>$_smarty_tpl->tpl_vars['goodItem']->value['goods_id']),$_smarty_tpl);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['goodItem']->value['goods_name'], ENT_QUOTES, 'UTF-8');?>
" target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['goodItem']->value['goods_name'], ENT_QUOTES, 'UTF-8');?>
</a></div>
						<div class="count"><span class="left">限量：<i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['goodItem']->value['goods_number'], ENT_QUOTES, 'UTF-8');?>
</i>份</span><span class="right">价值：<i><?php echo htmlspecialchars(smarty_helper_modifier_money_display($_smarty_tpl->tpl_vars['goodItem']->value['shop_price']), ENT_QUOTES, 'UTF-8');?>
</i>元</span></div>
						<div class="appbut">
							<a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/Goods/View','goods_id'=>$_smarty_tpl->tpl_vars['goodItem']->value['goods_id']),$_smarty_tpl);?>
" class="app" target="_blank">免费申请</a>
						</div>
						<div class="clear"></div>
					</div>
				</li>
	...
	<div class="recom_box">
		...
		<div class="show_box">
			<ul>
                            <?php  $_smarty_tpl->tpl_vars['goodItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['goodItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['hotGoodsArray']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['goodItem']->key => $_smarty_tpl->tpl_vars['goodItem']->value) {
$_smarty_tpl->tpl_vars['goodItem']->_loop = true;
?>
                           <li>
