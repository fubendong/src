<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-24 14:11:28
         compiled from "/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/my_order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150689050553f982109f3757-97340590%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b5eecafa6677c726406296508ea4ecbf5f81fcf' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/my_order.tpl',
      1 => 1408786197,
      2 => 'file',
    ),
    '91f2dd2f4e9039e902a6bac1ae4f773fe2f77cf2' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/my_layout.tpl',
      1 => 1408786197,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '150689050553f982109f3757-97340590',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f98210bbc9a3_56820206',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f98210bbc9a3_56820206')) {function content_53f98210bbc9a3_56820206($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
            ...
            <ul id="my_nav_tabbar" class="nav nav-tabs">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Profile'),$_smarty_tpl);?>
">我的资料</a>
                        </li>
                        <li>
                            <a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Address'),$_smarty_tpl);?>
">我的地址</a>
                        </li>
                        <li>
                            <a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Money'),$_smarty_tpl);?>
">我的资金</a>
                        </li>
                    </ul>
                </li>
...
">全部订单</a>
                        ...
                        <li>
                            <a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Order','orderStatus'=>1),$_smarty_tpl);?>
">已付款订单</a>
                        </li>
                        <li>
                            <a href="<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Order','orderStatus'=>0),$_smarty_tpl);?>
">未付款订单</a>
                        </li>
                    </ul>
                </li>
    ...
    <script type="text/javascript">
        window.bzf_set_nav_status.push(function ($) {
            $("#my_nav_tabbar li:has(a[href='<?php echo smarty_helper_function_make_url(array('controller'=>'/My/Order'),$_smarty_tpl);?>
'])").addClass("active");
        });
    </script>
    <!-- 页面主体内容 -->
    <div id="my_order_list_panel" class="row">
        ...
        <h4><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['myOrderTitle']->value)===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
</h4>
...
?>
                    <tr>
                        ...
                        <td class="price"><?php echo htmlspecialchars(smarty_helper_modifier_money_display(($_smarty_tpl->tpl_vars['orderInfoItem']->value['goods_amount']+$_smarty_tpl->tpl_vars['orderInfoItem']->value['shipping_fee']-$_smarty_tpl->tpl_vars['orderInfoItem']->value['discount']-$_smarty_tpl->tpl_vars['orderInfoItem']->value['extra_discount'])), ENT_QUOTES, 'UTF-8');?>
</td>
                        <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orderInfoItem']->value['pay_status_desc'], ENT_QUOTES, 'UTF-8');?>
,<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orderInfoItem']->value['order_status_desc'], ENT_QUOTES, 'UTF-8');?>
</td>
                        <td>
                            <a class="btn btn-small"
                               href="<?php echo smarty_helper_function_make_url(array('controller'=>"/My/Order/Detail",'order_id'=>$_smarty_tpl->tpl_vars['orderInfoItem']->value['order_id']),$_smarty_tpl);?>
">订单详情</a>
                            <?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orderInfoItem']->value['order_status'], ENT_QUOTES, 'UTF-8');?>
<?php $_tmp1=ob_get_clean();?><?php if (0==$_tmp1) {?>
                            <a class="btn btn-small btn-success"
                               href="<?php echo smarty_helper_function_make_url(array('controller'=>"/My/Order/Cart",'order_id'=>$_smarty_tpl->tpl_vars['orderInfoItem']->value['order_id']),$_smarty_tpl);?>
">现在付款</a>
                            <a class="btn btn-small btn-danger"
                               href="<?php echo smarty_helper_function_make_url(array('controller'=>"/My/Order/Cancel",'order_id'=>$_smarty_tpl->tpl_vars['orderInfoItem']->value['order_id']),$_smarty_tpl);?>
">取消订单</a>
                        </td>
                        <?php }?>
                    </tr>
