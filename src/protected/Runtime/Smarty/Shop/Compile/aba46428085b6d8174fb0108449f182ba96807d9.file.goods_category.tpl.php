<?php /* Smarty version Smarty-3.1-DEV, created on 2014-08-23 22:56:42
         compiled from "/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/goods_category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:97307437253f8abaa65d811-39397016%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aba46428085b6d8174fb0108449f182ba96807d9' => 
    array (
      0 => '/Users/fubendong/Sites/bzfshop/src/src/protected/Theme/Shop/shop/Tpl/goods_category.tpl',
      1 => 1408786197,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '97307437253f8abaa65d811-39397016',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53f8abaa874d55_77266060',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53f8abaa874d55_77266060')) {function content_53f8abaa874d55_77266060($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/fubendong/Sites/bzfshop/src/src/protected/Framework/Smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                    ...
                    <table class="table" id="bzf_goods_search_filter_panel" style="margin-bottom: 0px;">
                        ...
                        <tr>
                            <td colspan="3" style="background-color: #F7F7F7;font-size:14px;padding: 5px 5px;">
                                <span style="color:#FF6600;"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value['meta_name'], ENT_QUOTES, 'UTF-8');?>
</span>&nbsp;--&nbsp;商品筛选
                                <!-- 隐藏的设置 -->
                            ...
                            <div class="row bzf_goods_search_order_filter_bar">
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <!-- 隐藏的排序设置 -->
                                        <input type="hidden" name="category_id" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['category_id']->value)===null||$tmp==='' ? '' : $tmp), ENT_QUOTES, 'UTF-8');?>
"/>
