...
<div class="navbar navbar-static-top">
    <div class="navbar-inner bzf_header_login_register">
        <div class="container">
            ...
            |&nbsp;<a href="{{bzf_make_url controller='/My/Order'}}">个人中心</a>
            <!--
            &nbsp;|&nbsp;
    ...
    <div class="container">
        ...
        <div class="row bzf_footer_tail">
            ...
            <p><a target="_blank" href="http://www.bangzhufu.com">试客联盟商城</a> | <a target="_blank"
                                                                                 href="http://www.bzfshop.net">试客联盟</a>{{foreach $friend_link_json_data as $friendLink}}{{if !empty($friendLink['title'])}} |
                <a target="_blank" href="{{$friendLink['url']}}">{{$friendLink['title']}}</a>{{/if}}{{/foreach}}</p>

            <p>试客联盟 版权所有 ©Copyright 2010-{{$smarty.now|date_format:"%Y"}} All Rights Reserved</p>
